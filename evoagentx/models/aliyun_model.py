...
class AliyunLLM(BaseLLM):
    ...
    def get_completion_output(self, response: Any, output_response: bool = True) -> str:
        ...
        try:
            if not hasattr(response, 'output') or response.output is None:
                ...
                raise ValueError(f"Model response error (status={status_code}, code={code}): {error_msg}")
    ...
    def single_generate(self, messages: List[dict], **kwargs) -> str:
        ...
        try:
            ...
            raise RuntimeError(f"Error during single_generate of AliyunLLM: {str(e)}") from e
    ...
    async def single_generate_async(self, messages: List[dict], **kwargs) -> str:
        ...
        try:
            ...
            raise RuntimeError(f"Error during single_generate_async of AliyunLLM: {str(e)}") from e
